...
export const FACTORIES: FactoryDefinition[] = [
  { id: 'harbor-28', name: 'Harbor Silicon Fab', country: '台湾', nodeClass: 28, quality: 68, weeklyCapacity: 260, unitMultiplier: .9, signupFee: 4_800_000, minimumWeeks: 52, reliability: 89, unlockYear: 2015, setupWeeks: 5, reservationRate: 560, description: '旧世代設備を安価に確保できる。大型ダイでは歩留まりが厳しい。' },
  { id: 'shinano-16', name: 'Shinano Micro Works', country: '日本', nodeClass: 16, quality: 82, weeklyCapacity: 210, unitMultiplier: 1.04, signupFee: 8_800_000, minimumWeeks: 52, reliability: 96, unlockYear: 2016, setupWeeks: 7, reservationRate: 690, description: '品質と納期が安定。高信頼性シリーズと相性が良い。' },
  { id: 'meridian-10', name: 'Meridian Foundry', country: '米国', nodeClass: 10, quality: 87, weeklyCapacity: 170, unitMultiplier: 1.18, signupFee: 15_500_000, minimumWeeks: 78, reliability: 91, unlockYear: 2018, setupWeeks: 9, reservationRate: 840, description: '高性能設計向け。先端枠は高価で最低契約も長い。' },
  { id: 'aurora-7', name: 'Aurora Advanced Nodes', country: '韓国', nodeClass: 7, quality: 91, weeklyCapacity: 135, unitMultiplier: 1.36, signupFee: 26_000_000, minimumWeeks: 104, reliability: 88, unlockYear: 2020, setupWeeks: 11, reservationRate: 1_080, description: '高密度・高性能。供給事故が起きると損失が大きい。' },
  { id: 'polar-5', name: 'Polar Lithography Alliance', country: '欧州', nodeClass: 5, quality: 93, weeklyCapacity: 105, unitMultiplier: 1.49, signupFee: 39_000_000, minimumWeeks: 104, reliability: 92, unlockYear: 2023, setupWeeks: 12, reservationRate: 1_260, description: '高品質な先端プロセス。量は少ないが法人向けに強い。' },
  { id: 'quantum-3', name: 'Quantum Gate Systems', country: 'シンガポール', nodeClass: 3, quality: 96, weeklyCapacity: 80, unitMultiplier: 1.7, signupFee: 62_000_000, minimumWeeks: 130, reliability: 86, unlockYear: 2027, setupWeeks: 15, reservationRate: 1_560, description: '未来世代向け最先端工場。契約失敗は会社を傾ける。' },
];
